...
def main():
    print(f'Codigo executado às {datetime.datetime.now()}')
    ...
    with sync_playwright() as p:
        navegador = p.chromium.launch(headless=True, downloads_path= os.getcwd()) #Colocar true depois
    ...
    try:
        ...
        horario_atual = [
        [f"Gerado no dia {datetime.datetime.now().day}/{datetime.datetime.now().month}/{datetime.datetime.now().year} às {datetime.datetime.now().hour} h {datetime.datetime.now().minute} min {data.second} s."]
        ]
        ...
        print(f"Arquivo gerado para o sheets no dia {datetime.datetime.now().day}/{datetime.datetime.now().month}/{datetime.datetime.now().year} às {datetime.datetime.now().hour} h {datetime.datetime.now().minute} min {datetime.datetime.now().second} s.")

    except HttpError as err:
        print(err)

# schedule.every().day.at("08:00").do(main)
schedule.every(60).minutes.do(main) #executando a cada 60 min
